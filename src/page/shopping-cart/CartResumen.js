            ...
            <div className="w-full lg:w-96">
                <div className=" p-12 rounded-md bg-gray-100 text-left">
                    ...
                    <div className="mt-5 divide-y divide-gray-200">
                        <div className="flex justify-between py-5 font-bold text-xl leading-none">
                            <div>Subtotal</div>
                            <div>{fomatCurrency(shoppingCart.sub_total)}</div>
                        </div>
                        {shoppingCart.discount && (
                            <div className="flex justify-between py-5 font-bold text-xl text-green-500">
                ...
                <div className="flex mt-5">
                    ...
                    <button
                        ...
                        className="btn px-5 py-3 bg-yellow-500 text-white ml-3"
                    >
