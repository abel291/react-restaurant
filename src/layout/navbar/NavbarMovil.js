                        ...
                        >
                            <Disclosure.Panel>
                                <div className="px-2 pt-2 pb-3 space-y-2 text-center ">
                                    <>
                                        <NavLink onClick={close} to={routes.menu.path} className="nav-link-item ">
                                            {routes.menu.name}
                                        </NavLink>

                                        <NavLink onClick={close} to={routes.about.path} className="nav-link-item ">
                                            {routes.about.name}
                                        </NavLink>

                                        <NavLink onClick={close} to={routes.gallery.path} className="nav-link-item">
                                            {routes.gallery.name}
                                        </NavLink>

                                        <NavLink onClick={close} to={routes.hours.path} className="nav-link-item ">
                                            {routes.hours.name}
                                        </NavLink>
                                    </>
                                </div>
